/* ------------------------------------------------------------------
   ...
   NO SE EDITA A MANO. Se genera leyendo el propio DOCX oficial, para
   que el texto sea literal y no una transcripción. Si la Comisión
   revisa la plantilla, se vuelve a generar y se ve qué identificadores
   han cambiado.
